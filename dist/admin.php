...
<body class="bg-gray-100 font-sans">
    ...
    <div class="container mx-auto my-8 p-8 bg-white shadow-lg rounded-md">
        ...
        foreach (['add', 'delete', 'update', 'user_not_found', 'password_not_matched', 'change-password'] as $messageType) {
            ...
            <tbody>
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td class="p-2 border">
                                <a href="<?php echo SITEURL . '/dist/updatePassword.php?id=' . $id; ?>" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition">Change password</a>
